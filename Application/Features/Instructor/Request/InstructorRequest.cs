...
public sealed record InstructorCreateRequest
{
    ...
    [StringLength(30, MinimumLength = 4, ErrorMessage = "Gender should be between 4 to 30 characters")]
    ...
    [StringLength(150, MinimumLength = 4, ErrorMessage = "Qualification should be between 4 to 150 characters.")]

...
namespace Application.Interfaces.ClientInterfaces
{
    public interface IInstructor : IBaseClientRepository<tblInstructor>
    {
        ...
        Task<List<InstructorResponseV2>> GetByStatuses(CancellationToken cancellationToken = default);
        Task<List<InstructorInfo>> GetAllActive(CancellationToken cancellationToken = default);
